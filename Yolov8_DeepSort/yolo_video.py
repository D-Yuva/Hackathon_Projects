...
class ObjectDetection():
    ...
    def track_detect(self, detections, img, tracker):
        ...
        for track in tracks:
            ...
            # Find corresponding detection width and height
            for det in detections:
                bbox_det, conf, currentClass = det
                x1_det, y1_det, w, h = bbox_det
                if abs(x1 - x1_det) < 10 and abs(y1 - y1_det) < 10:  # Matching detection to track
                    ...
                    break  # Once matching detection is found, no need to continue the loop
...
detector = ObjectDetection(capture='/Users/yuva/development/yolov8_deepsort/Video/People_Walking.mp4')    
detector.call_()
